...
let Brand = (_dec = (0, _typeorm.Entity)('brands'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)('text'), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)('text'), _dec7 = (0, _classTransformer.Transform)(({
  value
}) => value ? `${process.env.APP_API_URL}files/${value}` : null), _dec8 = Reflect.metadata("design:type", String), _dec9 = (0, _typeorm.Column)({
  type: 'text',
  name: 'background_image'
}), _dec10 = (0, _classTransformer.Transform)(({
  value
}) => value ? `${process.env.APP_API_URL}files/${value}` : null), _dec11 = Reflect.metadata("design:type", String), _dec12 = (0, _typeorm.CreateDateColumn)(), _dec13 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec14 = (0, _typeorm.UpdateDateColumn)(), _dec15 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = class Brand {
  constructor() {
    ...
    _initializerDefineProperty(this, "backgroundImage", _descriptor4, this);
  ...
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "image", [_dec6, _dec7, _dec8], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "backgroundImage", [_dec9, _dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
