...
let DestroySaleService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute(id) {
    ...
    if (!sale) {
      throw new _AppError.default('Sale not found');
    }
...
var _default = DestroySaleService;
